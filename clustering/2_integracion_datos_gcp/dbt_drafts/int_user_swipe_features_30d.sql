...
agg as (
    select
        ...
        cast(null as float64) as avg_dwell_ms_30d,
        cast(null as float64) as avg_right_dwell_ms_30d,
        ...
        cast(null as float64) as local_like_rate_30d,
        cast(null as float64) as local_swipe_share_30d,
        avg(if(liked and fecha_evento is not null, date_diff(fecha_evento, date(event_timestamp), day), null)) as avg_days_until_event_liked_30d,
        cast(null as float64) as avg_price_mid_liked_30d,
        cast(null as float64) as median_price_mid_liked_30d,
        cast(null as float64) as avg_price_mid_disliked_30d,
