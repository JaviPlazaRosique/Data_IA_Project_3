...
| Route | Page |
|-------|------|
| `/` | Discover — hero, categories, curated events |
| `/planner` | AI Planner — chat interface + itinerary sidebar |
| `/event/:id` | Event Details — weather, booking, map, ratings |
| `/map` | Map Explorer — interactive Leaflet map with event pins |
| `/profile` | User Dashboard — preferences, saved events, history |
