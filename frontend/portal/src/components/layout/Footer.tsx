export default function Footer() {
  return (
    <footer className="bg-surface border-t border-outline-variant/20 py-12 px-8 mt-24">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
        <div className="text-on-surface/40 text-xs font-medium font-body">
          © 2024 The Electric Curator. Powered by Neon Nocturne.
        </div>
        <div className="flex gap-8">
          <a href="#" className="text-on-surface/40 hover:text-primary text-xs font-medium transition-opacity">Privacy Policy</a>
